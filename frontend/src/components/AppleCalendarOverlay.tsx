...
export default function AppleCalendarOverlay({ selectedDate, onSelectDate, onClose }: AppleCalendarOverlayProps) {
        ...
        <div className="grid grid-cols-7 px-4 pb-5 gap-y-1">
          {days.map((day, i) => {
            ...
            return (
              ...
              >
                <span className={`text-base font-medium leading-none ${isSelected ? 'text-primary-foreground' : ''}`}>
                  {format(day, 'd')}
                </span>
