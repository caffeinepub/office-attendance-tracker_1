...
import { Clock, LayoutDashboard, Calendar, BarChart2, Download, LogOut, User } from 'lucide-react';
      ...
      <header className="sticky top-0 z-40 bg-background/95 backdrop-blur-md border-b border-border/50 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            />
            <div>
              <h1 className="text-sm font-display font-bold text-foreground leading-none">SwipeTrack Pro</h1>
          ...
          <div className="flex items-center gap-1">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="tap-target flex items-center justify-center rounded-xl hover:bg-secondary transition-colors">
