...
import { LogIn, Clock, BarChart2, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="relative flex-1 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundImage: "url('/assets/generated/hero-welcome.dim_1200x800.png')" }}
        />
        {/* Gradient overlay */}
        ...
        <div className="relative z-10 flex flex-col items-center px-6 pt-16 pb-8 text-center max-w-sm mx-auto">
          ...
          <div className="w-full space-y-3 mb-10">
            {[
              ...
              <div key={text} className="flex items-center gap-3 bg-card/80 backdrop-blur-sm rounded-xl px-4 py-3 border border-border/50">
